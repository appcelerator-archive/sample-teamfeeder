...
//@interface TeamFeederObject : NSObject
//@end

@interface TeamFeederObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TeamFeederObject class]])
		{
			for (NSString *key in [[(TeamFeederObject*)o modules] allKeys])
			{

...
// in simulator we redefine to format for TeamFeeder Developer console
...
{\
	NSString * exceptionName = [@"org.teamfeeder." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.teamfeeder";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UITeamFeederNativeItemNone = -1, 
	UITeamFeederNativeItemSpinner = -2,
	UITeamFeederNativeItemProgressBar = -3,
	
	UITeamFeederNativeItemSlider = -4,
	UITeamFeederNativeItemSwitch = -5,
	UITeamFeederNativeItemMultiButton = -6,
	UITeamFeederNativeItemSegmented = -7,
	
	UITeamFeederNativeItemTextView = -8,
	UITeamFeederNativeItemTextField = -9,
	UITeamFeederNativeItemSearchBar = -10,
	
	UITeamFeederNativeItemPicker = -11,
	UITeamFeederNativeItemDatePicker = -12,
	
	UITeamFeederNativeItemInfoLight = -13,
	UITeamFeederNativeItemInfoDark = -14,
	
	UITeamFeederNativeItemDisclosure = -15,
	
	UITeamFeederNativeItemContactAdd = -16
};
